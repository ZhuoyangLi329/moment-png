...
def main():
    ...
    d=json.loads((r/'results/run_provenance_v87.json').read_text()); d['schema']='run_provenance_v88'; d['created_utc']=datetime.datetime.now(datetime.timezone.utc).isoformat(); d['github_main_commit']=a.commit
    d['source_alignment']='results/main_nersc_source_alignment_v46.json'; d['source_alignment_sha256']=sha(r/'results/main_nersc_source_alignment_v46.json'); d['completion_audit']='results/completion_audit_v1.json'; d['completion_audit_sha256']=sha(r/'results/completion_audit_v1.json'); d['batch_outputs']['source_alignment_v46']='results/main_nersc_source_alignment_v46.json'; d['batch_outputs']['completion_audit']='results/completion_audit_v1.json'; d['status']='PARTIAL'
